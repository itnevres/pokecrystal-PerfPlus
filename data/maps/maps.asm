...
MapGroup_Cerulean:
	...
	map CeruleanCave1F, TILESET_CAVE, CAVE, LANDMARK_ROUTE_4, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CeruleanCave2F, TILESET_CAVE, CAVE, LANDMARK_ROUTE_4, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CeruleanCaveB1, TILESET_CAVE, CAVE, LANDMARK_ROUTE_4, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
